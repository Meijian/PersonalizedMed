...
train_anno1 = pd.read_csv("train_variant_annotation1.csv")
...
print(train_variants_df.shape,test_variants_df.shape,train_text_df.shape,test_text_df.shape,train_anno1.shape)
...
X_test = ssp.hstack([X_test, pd.DataFrame(X_test_text)], format='csr')
